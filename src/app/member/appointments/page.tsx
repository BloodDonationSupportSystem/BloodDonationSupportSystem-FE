...
import { Typography, Card, Spin, Table, Tag, Button, Tooltip, Calendar, Badge, Tabs, Modal, Form, Input, DatePicker, TimePicker, Select, Empty, Alert, message, Descriptions, Row, Col } from 'antd';
import {
  CalendarOutlined,
  ClockCircleOutlined,
  CheckCircleOutlined,
...
export default function AppointmentsPage() {
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      ...
      setError(null);
      setIsDonorProfileMissing(false);
